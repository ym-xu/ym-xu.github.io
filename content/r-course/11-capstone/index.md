...
- **样本量与事件数**:有多少例、结局事件(毒性 / 死亡 / 复发)有多少个。⚠️ 回顾性研究里**事件数**决定能放几个自变量(逻辑/Cox 的 EPV 规则,见 [Lesson 7](../07-logistic-regression/))。
...
- **编码变量**:治疗方案、FIGO 分期、剂量学指标(EBRT、近距离剂量、D90、D2cc)、年龄,整理成规范的列
