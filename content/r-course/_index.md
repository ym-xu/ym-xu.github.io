...
每节课都围绕一个临床研究里真实会遇到的问题展开,代码可以直接抄着改。建议按顺序学:**L1–3** 打编程基础(R、数据整理、画图),**L4** 建立统计直觉,**L5–8** 临床统计主线(基线表 Table 1、组间比较、逻辑回归、线性回归),**L9–10** 生存与竞争风险分析,**L11** 放射生物剂量换算(EQD2/BED),**L12** 极小样本(病例系列)的诚实分析,**L13** 把全流程用到你自己的数据上、产出可投稿的结果。
